...
def test_point():
    point1 = Point(from_dms(50, 3, 59, 'N'), from_dms(5, 42, 53, 'W'))
    point2 = Point(point1.lat, point1.lon)
    point1.to_radians()
    point1.to_degrees()
    assert_equal(point1.lat, point2.lat)
    assert_equal(point1.lon, point2.lon)
...
def test_endpoint():
    ...
    assert_equal(to_dms(end.lat, 'lat'), (53, 11, 17, 'N'))
    assert_equal(to_dms(end.lon, 'lon'), (0, 7, 59, 'E'))
